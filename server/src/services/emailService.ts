      ...
      <html>
        <head>
          ...
          <style>
            ...
            .header { background-color: #f8f9fa; padding: 15px; display:flex;justify-content:center;}
            .content { padding: 30px 20px; }
            .title{font-weight:700;color:#ffd700;width:7ch;text-align:left;line-height:1;}
            ...
            .footer { background-color: #f8f9fa; padding: 20px; text-align: center; font-size: 12px;color:#2c3e60; }
          </style>
        </head>
        <body>
          <div class="container">
            ...
            <div class="content">
              <h2>Bună ${name}!</h2>
              <p>Mulțumim pentru înregistrarea pe Lost & Found. Pentru a-ți activa contul, te rugăm să-ți verifici adresa de email.</p>
              ...
              <p>Sau copiază și introdu următorul link în browser:</p>
