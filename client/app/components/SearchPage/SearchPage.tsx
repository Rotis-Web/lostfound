          ...
          {isInitializing ? (
            ...
            <>
              <div
                ...
                style={{
                  textAlign:
                    totalCount === 0 && searchResults.length === 0
                      ? "center"
                      : "left",
                }}
              >
                <h2>
                  ...
                  {(totalCount === 1 ||
                    (totalCount === 0 && searchResults.length === 1)) &&
                    "1 rezultat"}
                  {(totalCount > 1 ||
                    (totalCount === 0 && searchResults.length > 1)) &&
                    `${
                      totalCount > 0 ? totalCount : searchResults.length
                    } rezultate`}
                </h2>
                {(totalCount > 0 || searchResults.length > 0) && (
                  <p className={styles.pageinfo}>
                    ...
                    {totalPages > 0
                      ? totalPages
                      : Math.ceil(searchResults.length / POSTS_PER_PAGE)}
                  </p>
                )}
              </div>
