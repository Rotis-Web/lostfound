          ...
          <form onSubmit={handlePasswordChange} className={styles.form}>
            <div className={styles.inputbox}>
              ...
              <input
                ...
                className={passwordErrors.oldPassword ? styles.error : ""}
                aria-required="true"
              />
          ...
          <form onSubmit={handleDeleteAccount} className={styles.form}>
            <div className={styles.inputbox}>
              ...
              <input
                ...
                className={deleteAccountErrors.password ? styles.error : ""}
                aria-required="true"
              />
            ...
            <div className={styles.inputbox}>
              <label htmlFor="confirmationText" className={styles.hidden}>
                Text de confirmare
              </label>
              <input
                type="text"
                ...
                className={
                  deleteAccountErrors.confirmationText ? styles.error : ""
                }
                aria-required="true"
              />
            ...
            <div className={styles.checkboxcontainer}>
              <label className={styles.checkboxlabel}>
                ...
                />
                <p>
                  Am citit și înțeleg Politica de Confidențialitate și confirm
                  că doresc să îmi șterg contul definitiv.
                </p>
              </label>
